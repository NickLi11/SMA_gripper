...
for j in draw:
    u=u+1
    cv2.circle(img2, (int(j[0]), int(j[1])), 10, (0, 0, 255), 3)
cv2.line(img2,(int(draw[0][0]),int(draw[0][1])),(int(draw[1][0]),int(draw[1][1])),(155,155,155),5)
cv2.line(img2,(int(draw[1][0]),int(draw[1][1])),(int(draw[2][0]),int(draw[2][1])),(155,155,155),5)
